 ...
 * @author ricar
 */
public class Proyecto_II extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        verproceso = new javax.swing.JButton();
        ...
        fieldMemoriaSecundaria.setText("5000");
        ...
        jLabel18.setText("Quantum");

        verproceso.setText("Ver proceso");
        verproceso.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                verprocesoActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(crearProceso, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 28, Short.MAX_VALUE)
                        .addComponent(verproceso)))
                .addContainerGap())
        );
        ...
        tablaProcesos.setBackground(new java.awt.Color(204, 255, 255));
        ...
        jPanel1.getAccessibleContext().setAccessibleName("Instalacion");
    ...
    private void instalarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_instalarActionPerformed
        ...
        fieldPagina.setText("");
        fieldMemoriaSecundaria.setText("");
        fieldMemoriaPrincipal.setText("");
    ...
    private void verprocesoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verprocesoActionPerformed
        ver ver=new ver();
        
    }//GEN-LAST:event_verprocesoActionPerformed
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Proyecto_II.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Proyecto_II().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton verproceso;
